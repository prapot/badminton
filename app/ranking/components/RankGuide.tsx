        ...
        <div className="mt-16 mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                    ...
                    { name: 'Platinum', divs: 'V, IV, III, II, I', stars: 4, color: 'from-cyan-400 to-blue-600', icon: '💎', desc: 'ก้าวเข้าสู่ทำเนียบยอดฝีมือ', divArray: ['V', 'IV', 'III', 'II', 'I'] },
                    { name: 'Diamond', divs: 'V, IV, III, II, I', stars: 4, color: 'from-blue-600 to-indigo-800', icon: '💠', desc: 'ระดับสูงสุดก่อนเข้าสู่ทำเนียบแชมป์', divArray: ['V', 'IV', 'III', 'II', 'I'] },
